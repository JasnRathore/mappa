...
export const TitleBar: React.FC<TitleBarProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Center: Project Name */}
      {/*
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-2 pointer-events-none whitespace-nowrap">
        <span className="text-[11px] font-bold tracking-tight text-foreground/80">Mappa</span>
      ...
      */}
      ...
      <div className="flex items-center h-full">
        {project && (
          ...
          <div className="flex items-center gap-1 px-4 border-r border-border mr-1 h-6">
            <Button variant="ghost" size="sm" onClick={() => setProject(null)} className="h-7 text-[10px] font-bold uppercase tracking-wider text-muted-foreground hover:text-foreground">
              Project Manager
            </Button>
          </div>
        )}
